<body class="skin-josh">
    <header class="header">
        <a href="<?php echo base_url('C_user/index');?>" class="logo">
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo base_url('resources/user.jpg')?>" style="width: 35px; height: 35px;" class="img-circle img-responsive pull-left" height="35" alt="riot">
                            <div class="riot">
                                <div>

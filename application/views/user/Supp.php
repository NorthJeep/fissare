                ...
                <div class="clearfix"></div>
                    <div class="col-md-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" id="addSystemForm" name="addRoleForm" data-source="<?php echo base_url('C_user/supported_System')?>" novalidate>
                                    <fieldset>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-warning">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" id="editSystemForm" name="editSystemForm" data-source="<?php echo base_url('C_user/supported_System')?>" novalidate>
                                    <fieldset>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-success filterable" style="overflow:auto;">
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-bordered" id="tblList" data-source="<?php echo base_url('C_user/supported_System')?>" novalidate>
                                    <thead>
                                        <tr>
                                            <th width="15%">User System ID</th>
                                            <th>System Name</th>
